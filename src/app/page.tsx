...
import { SelectSort } from "@/components/Input/SelectSort";
...
export default function Home() {
  ...
  return (
    <main className="absolute top-0 h-screen w-screen z-[-2] bg-[#fff] bg-[radial-gradient(#000_1px,#150229_1px)] bg-[size:40px_40px]">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              >
                {requiresReset ? (
                  ...
                  <FaPlay className="text-system-green60 h-8 w-8" />
                )}
              </button>
            </div>

            <div className="hidden sm:flex absolute top-[120%] left-0 w-11/12">
              <div className="flex w-full text-gray-400 p-4 rounded border border-system-purple20 bg-system-purple80 bg-opacity-10 gap-6">
                ...
                <div className="flex flex-col items-start justify-start w-1/4 gap-2">
                  <h3 className="text-lg flex-nowrap">Time Complexity</h3>
